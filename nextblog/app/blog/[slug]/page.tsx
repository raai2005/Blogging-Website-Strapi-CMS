    ...
    <div className="min-h-screen bg-zinc-950">
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-12 pt-12 border-t border-zinc-800/50">
          <div className="bg-zinc-900/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-zinc-800/50 text-center">
            <svg className="w-16 h-16 mx-auto mb-6 text-violet-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            <h3 className="text-2xl font-bold text-white mb-4">Have Questions or Feedback?</h3>
            <p className="text-zinc-400 mb-6 text-lg">We'd love to hear from you! Visit our contact page to get in touch.</p>
            <Link 
              href="/contact"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-violet-500 to-purple-600 text-white rounded-xl hover:from-violet-600 hover:to-purple-700 transition-all duration-300 font-semibold shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50"
            >
              Contact Us
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
